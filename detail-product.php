    ...
    <div class="container">
        	<div class="row">
               <div class="col-xs-4 item-photo">
                    <img style="max-width:100%;" src="img/ipad11-pro-12.9.jpg" />
                </div>
                <div class="col-xs-5" style="border:0px solid gray">
                    <!-- Datos del vendedor y titulo del producto -->
                    <h3>Ipad Pro M1 12.9inch</h3>    
                    <h5 style="color:#337ab7">Manufacturers <a href="#">Apple</a> · <small style="color:#337ab7">(Mỹ)</small></h5>
        
                    <!-- Precios -->
                    <h6 class="title-price"><small>PRECIO OFERTA</small></h6>
                    <h3 style="margin-top:0px;">U$S 1.099</h3>
